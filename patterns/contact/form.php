 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"},"blockGap":"var:preset|spacing|sm"},"width":{"all":"100%"},"border":{"radius":"30px"},"elements":{"link":{"color":{"text":"var:preset|color|primary-200"}}},"typography":{"fontStyle":"normal","fontWeight":"500"}},"textColor":"primary-200","className":"is-style-default","layout":{"type":"default"},"fontSize":"16","animation":{"name":"fade-in-up","duration":1},"shadowPreset":"xxl"} -->
<div class="wp-block-group is-style-default has-primary-200-color has-text-color has-link-color has-16-font-size has-animation  has-shadow has-xxl-shadow" style="border-radius:30px;margin-top:var(--wp--preset--spacing--lg);margin-bottom:var(--wp--preset--spacing--lg);font-style:normal;font-weight:500;animation-name:fade-in-up;animation-duration:1s;animation-iteration-count:1"><!-- wp:columns -->
